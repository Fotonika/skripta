...
bomo zasedbene enačbe in pojasnili delovanje laserjev. Spoznali bomo prednosti 
...
Poglejmo primer. V Ti:safir laserju \index{Laser!Ti:safir}je širina ojačenja $\Delta \nu_G = 100~\si{THz}$, 
...
Danes je meter je definiran kot pot, ki jo svetloba v vakuumu prepotuje v \index{Definicija metra}
