...
se tako na en obhod po enačbi (\ref{eq:djG}) poveča za:\index{Stimulirano sevanje}
\begin{equation}  
...
\beq
{\cal {R}}_2 = 1-2\alpha L \left(\sqrt{G/\alpha}-1\right)\!\!.
\eeq
\end{naloga}
...
Iz enačbe (\ref{5.20}) je razvidno tudi, da je spektralna širina, ki je
...
črpanje nad pragom, svetloba izhaja iz laserja.\index{Sunkovni laser!{preklop črpanja}}\index{Črpanje}
...
vakuumu prepotuje v \index{Definicija metra}
