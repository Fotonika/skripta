...
čemer se izseva foton. Temu procesu pravimo stimulirano sevanje\index{Stimulirano sevanje} ali 
...
enačbo~(\ref{4.18}) in upoštevali $w=j/c$. Zasedenost višjega nivoja $N_{2}$ lahko izrazimo s 
...
atom v vzbujenem stanju (stanju 2), polje pa ima $n_{\alpha}$ fotonov v enem samem stanju $\alpha$.
...
na časovno enoto, pri čemer s funkcijo $\delta$ izberemo le prehod, pri katerem se energija ohranja, 
enaka
\begin{equation}
...
Vpeljemo še $\mathcal{V} = -e \langle1|\hat{x}|2\rangle$.
...
\end{equation}
Krožno frekvenco $\Omega_R = \mathcal{V} E_0/\hbar$ imenujemo Rabijeva krožna frekvenca.\index{Rabijeva frekvenca}
