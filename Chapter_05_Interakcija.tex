...
je $N_{2}<N_{1}$ in $dj$ negativen, pride torej do absorpcije svetlobe.
Zapišemo 
\begin{equation}
\frac{dj}{j} = -\mu dz.
\label{eq:jabs}
...
prehode iz stanja $|2\rangle$  bomo zanemarili. Zasedenost stanja $|2\rangle$ se
...
spremembe integracijske spremenljivke nastopi še dodaten faktor $1/\hslash$ in zapišemo
\begin{equation}
...
\begin{equation}
\frac{d c_1}{dt}=-\frac{i}{2\hslash} \mathcal{V} E_0 e^{-i\Delta t}\, c_2 
\qquad \mathrm{in} \qquad
\frac{d c_2}{dt}=-\frac{i}{2\hslash} \mathcal{V} E_0 e^{i\Delta t}\, c_1,
\label{eq:rabi2}
\end{equation}
...
\label{eq:rabi3} \\
c_2(t)&=\frac{\mathcal{V}E_0}{i\hslash \Omega} e^{i\Delta t/2}\, \sin\left(\frac{\Omega t}{2}\right).
\label{eq:rabi4}
\end{align}
