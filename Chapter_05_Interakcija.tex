...
Vsako stoječe valovanje je določeno z valovnim 
...
označuje trojico števil $l$, $m$ in $n$ ter še obe polarizaciji. 
...
\label{4.12}
\end{equation}
pri čemer sta $\beta = 1/k_BT$ in $k_B$ Boltzmannova konstanta. 
...
Verjetnost za prehod na časovno enoto\index{Verjetnost za prehod}, 
ki jo označimo z $r_{12}$, 
je sorazmerna spektralni gostoti energije polja 
\index{Spektralna gostota energije}$u(\omega)$, 
...
kadar je spektralna gostota \index{Spektralna gostota energije}
...
Število atomov v določenem atomskem nivoju imenujemo zasedenost 
stanj.\index{Zasedenost stanj} 
Ker zaenkrat obravnavamo preproste modele atomov z zgolj 
dvema nivojema, zapišemo samo dve zasedenosti\index{Dvonivojski sistem}. Naj bodo $N_1$ zasedenost 
...
Gostota vpadnega svetlobnega toka je $j_0$, za saturacijsko
...
nivo, ki leži nad izbranim parom nivojev. Tako črpanje uporabljamo na primer v laserjih Nd:YAG in Ti:safir.
\index{Laser!Nd:YAG} \index{Laser!Ti:safir}

V polprevodniških laserjih \index{Laser!polprevodniški}dosežemo obrnjeno zasedenost med 
...
To je plin atomov s tremi nivoji, tako imenovani trinivojski sistem (slika~\ref{fig:3nivojski}\,a). Osnovno stanje, ki 
...
Poleg tega je vsota vseh treh zasedenosti enaka številu 
...
Mehanizem črpanja 
smo s tem skrili v $r$ in prav nič ni pomembno, na kakšen način 
...
za Nd:YAG\index{Laser!Nd:YAG} ($1064~\si{nm}$ in 
...
Dopplerjeva razširitev v plinu je Gaussove oblike\index{Spekter!Gaussov}.
...
$\Delta\omega_{D}\,=\,8\cdot10^{9}~\si{\second}^{-1}$ oziroma 
$\Delta\nu\,=\,1,4~\si{\giga\hertz}$. 
...
\label{4.88}
\end{equation}
 Če je gostota vpadnega svetlobnega toka majhna, lahko razvijemo imenovalec. Sledi:
\begin{equation}
...
Bennettova 
vdolbina\footnote{~Ameriški fizik William Ralph Bennett Jr., 
1930--2008.}\footnote{~W. R. Bennett Jr., Phys. Rev. $\mathbf{126}$, 580 (1962).}.
...
Willis Eugene Lamb Jr., 1913--2008.}\index{Lambova vdolbina}.\footnote{~R. A. McFarlane,
...
ko smo v integraciji $g(\omega_S-\omega_{0}+kv)$ nadomestili kar z $\delta$ funkcijo. 
...
operatorji. Vstavimo jih v razvoj električnega polja (enačba~\ref{4.50}):
\begin{equation}
