...
obnašanje. Pri teh frekvencah, imenujemo jih lastne frekvence\index{Lastne frekvence resonatorja}
...
Fabry-Perotov interferometer\index{Fabry-Perotov interferometer}, ki ga bomo podrobneje
...
razširjeno emisijsko črto v plinu\index{Dopplerjeva razširitev} (glej razdelek~\ref{Razsiritev}). 
...
Razlika med frekvencama dveh zaporednih lastnih nihanj\index{Lastne frekvence resonatorja} z
indeksoma 
$n$ in $n+1$ je:
...
z veliko odbojnostjo, imenujemo \index{Fabry-Perotov 
...
\boxeq{eq:stabilnost}{
0\leq\left(1-\frac{L}{R_{1}}\right)\left(1-\frac{L}{R_{2}}\right)\leq 1.
}
...
koncentrični \index{Resonator!koncentrični}resonator (b), 
...
dobrota resonatorja\index{Dobrota resonatorja} $Q$, ki jo vpeljemo kot
...
interferometra\index{Fabry-Perotov interferometer} (enačba~\ref{eq:Fabry-Perot-prepustnost}) pri pravokotnem vpadu  okoli vrha pri $\omega_{n}$:
\begin{equation}
...
simetričnega konfokalnega resonatorja\index{Resonator!konfokalni}. Privzemimo, da je brez izgub. 
...
\label{3.78}
\end{equation}
Poodoben račun in razmislek naredimo tudi za $g(Y)$. 
...
Postavimo izračunano jakost električnega
...
Ta pogoj da enačbo za krožno frekvenco\index{Lastne frekvence resonatorja}:
\begin{equation}
