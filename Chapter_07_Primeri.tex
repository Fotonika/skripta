...
ojačuje v sredstvu, ki je enako kot v osnovnem laserju in ki je v kolikor je le
mogoče visokem stanju obrnjene zasedenosti. V več ojačevalnih korakih 
se doseže zelo velika svetlobna moč. 
...
celico metana, ki infrardeči del svetlobe močno absorbira, vidnega pa ne.
...
Kot drugi primer plinskega laserja obravnavajmo argonski ali natančneje
argonov ionski (Ar$^+$) laser,
...
pogosto več deset $\si{\kilo\watt}$, in močnejši argonski laserji morajo biti
...
Neodimski laser je primer štirinivojskega laserskega sistema, 
...
ali močnimi ksenonovimi svetilkami za zvezno delovanje 
...
singletno stanje $S_1$. Prek trkov z molekulami topila vzbujena barvilna molekula
...
\label{eq:7FD}
\end{equation}
pri čemer $E_F$ označuje Fermijevo energijo. Pri $T=0$ so vsa stanja pod \index{Fermijeva energija}
...
Najpomembnejši primer je plast $p$-GaAs, ki se nahaja med plastema  \index{Heterostruktura}
