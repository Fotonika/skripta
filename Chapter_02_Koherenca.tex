...
\ref{sec:casovna-koherenca}, za zdaj naj pojasnimo le to, da je časovna
...
Za primerjavo sta prikazana tudi ravni val\index{Ravni val} $E=\sqrt{N}E_{1}e^{-i\omega t}$
...
Koherenčni čas\index{Koherenčni čas} $t_{c}$ natančneje definiramo 
...
v nekaterih vlakenskih laserjih\index{Laser!vlakenski} pa presega $100~\si{\kilo\metre}$.
...
frekvenci $\omega$ in je enak intenziteti\index{Intenziteta}
...
(enačba~\ref{eq:avtokorelacija}). Privzeli smo, da velja $T\gg t_{c}$, zato je
...
Valovanje z dolgim $t_c$ ima zelo majhno spektralno širino (ozek spekter), medtem ko ima 
...
\begin{naloga}\label{naloga-Planck}
...
Zapišimo zgornje ugotovitve nekoliko natančneje. Na zaslonu $B$
...
Polje v posamezni odprtini je vsota prispevkov s celotnega izvora:
\begin{equation}
...
ploskev $S_{c} \sim d_c^2$\index{Koherenčna ploskev}. 
...
\begin{figure}[ht]
\begin{center}
\subfloat{\def\svgwidth{0.37\textwidth}\input{slike/02_interferenca01.pdf_tex}}\quad
\subfloat{\def\svgwidth{0.37\textwidth}\input{slike/02_interferenca02.pdf_tex}}\\
\subfloat{\def\svgwidth{0.37\textwidth}\input{slike/02_interferenca03.pdf_tex}}\quad
\subfloat{\def\svgwidth{0.37\textwidth}\input{slike/02_interferenca04.pdf_tex}}
...
Svetlobo iz izbrane zvezde zberejo v teleskop prek dveh manjših parov
