...
(razširitev spektralne črte zaradi medatomskih trkov) in za svetlobo z Gaussovim spektrom\index{Spekter!Gaussov}
...
izsevana iz LED sijalk\index{Svetleče diode}, ima koherenčno dolžino $\sim20$--$100~\si{\micro\metre}$.
...
temperaturo $T$, približno enak $t_{c}\approx{\hslash}/{k_{B}T}$.\index{Sevanje črnega telesa}
Izhajaj iz Planckovega spektra za sevanje črnega telesa\index{Spekter!Planckov} 
\begin{equation}
...
\caption{Shema interferenčnega eksperimenta. V ravnini $z=0$ je razsežno svetilo s polmerom $R$. 
Svetloba iz različnih delov svetila prepotuje različno dolgo pot do dveh odprtin v ravnini $A$, 
zato sta njuni interferenčni sliki na zaslonu $B$ premaknjeni.}
...
\end{equation}
meri skupni premik interferenčnih prog, ki se pojavi, kadar svetilo
ne leži na isti osi kot odprtini v zaslonu. Če ležita odprtini v ravnini $A$ 
...
od nekaj deset svetlobnih let, metoda odpove.\index{Michelsonov interferometer}
\end{remark}
