...
omejitev niso izgube, ampak popačitev signala zaradi disperzije.
...
lahko atenuacijski koeficient v ukrivljenem vlaknu zapišemo kot:
\begin{equation}
A \propto e^{-CR},
\end{equation}
...
\index{Erbij}\index{Optično vlakno!dopirano z erbijem}
