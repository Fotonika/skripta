...
pa sledi prekrivalni integral, ki ga moramo seveda ustrezno normirati. 
...
Omejimo se na spoj enorodovnih vlaken, v katerih krajevni del jakosti 
...
\begin{align}
E_1(x,z) &= A(z) \psi_1(x) e^{i \beta_1 z} \qquad \mathrm{in}\\
...
\end{multline}
Zaradi počasnega spreminjanja  smo člena z drugim odvodom $\partial^2 A/\partial z^2$ in $\partial^2 B/\partial z^2$ zanemarili. Zapišemo enačbi za nemoteni funkciji $\psi$
\begin{equation}
