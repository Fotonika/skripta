...
Zapisano sekularno enačbo rešujemo ali numerično ali pa se je lotimo grafično in 
...
$V>2,405$. Polmer, pri katerem se valovanje TE$_{01}$ (ali TM$_{01}$) valovanje 
...
Dobimo:\index{Optično vlakno!število rodov}\footnote{~Glej npr. C. R. Pollock, {\it Fundamentals of Optoelectronics}, Irwin (1995).}
\begin{equation} 
N = \frac{4 V^2}{\pi^2}.
\end{equation}
...
Zapišemo lomni količnik, pri čemer vpeljemo brezdimenzijski parameter $\Delta$:
\begin{equation}
...
zelena črta -- absorpcija na OH ionih in modra črta --
