...
Za nazornejšo predstavo izpišimo notranja produkta tenzorjev z vektorji 
po komponentah:
\begin{equation}
...
Kadar je absorpcija v snovi majhna, lahko matriko poenostavimo
...
Slabost optičnega usmerjanja je razmeroma nizek izkoristek zaradi majhne frekvence
 ...
 v snovi ni prevelika. \index{LiTaO$_3$}\index{LiNbO$_3$}\index{LiNbO$_3$}\index{GaP} \index{GaSe} \index{GaAs}
 \newpage
...
\index{Optični Kerrov pojav|see {Kerrov pojav}}
...
Izračunaj še kritično moč za pojav solitonov v CS$_{2}$\index{CS$_2$}, če je valovna
...
kot\index{Susceptibilnost!kompleksna}:
\begin{equation}
