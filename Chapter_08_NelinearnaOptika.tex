...
\begin{definition}
Oceni gostoto svetlobnega toka, pri kateri postane nelinearen 
prispevek k polarizaciji znaten in velja 
 $$\frac{P_{NL}}{P_L} \sim 10^{-5}.$$
Tipične vrednosti so $\sim~1~\si{\mega\watt/\centi\metre^2}$. Ker je to z navadnimi
...
Pri tem je $\delta k$ razlika valovnih vektorjev, $\chi_{ef}$ pa efektivna susceptibilnost. 
...
Pri tem $\Delta k$ označuje razliko valovnih vektorjev,
$L$ pa prepotovano pot v kristalu.}
\label{fig:shg2}
\end{figure}
...
\begin{equation}
\frac{1}{n_o^2(2\omega)} = \frac{1}{n^2(\omega,\vartheta)}=
