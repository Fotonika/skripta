...
\end{equation}
Primerjajmo rezultat s tabelo~(\ref{table:chi}). V tabeli
...
$\omega_3$. Pri tem nastane nedejaven žarek s krožno frekvenco $\omega_2$.}
\label{fig:opa2}
\end{figure}
...
nedejavnega žarka, ki nastane zaradi ohranitve
energije ($|A_2/A_{20}|^2$). 
...
Ocenimo, pri kateri moči vpadne svetlobe se pojavijo krajevni solitoni. 
...
tudi sipanje, pri katerem se energija izhodnih fotonov razlikuje od energije vpadnih. 
...
Tipičen Brillouinov premik je $\sim 10^{10}\si{\hertz}$. \index{Brillouinovo sipanje}
