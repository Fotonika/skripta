...
Za nazornejšo predstavo izpišimo notranja produkta tenzorjev z vektorji še 
po komponentah:
\begin{equation}
...
\label{SHGGauss_3}
\end{align}
s pripadajočim sistemom kompleksno konjugiranih enačb. Črtica označuje odvajanje po $z$. 
...
\label{8.81}
\end{equation}
 kjer je $\mathbf{r}$ krajevni vektor v ravnini $xy$ in $k_{0}=\tilde{n}\omega/c_0$ valovno število brez upoštevanja nelinearnosti.
