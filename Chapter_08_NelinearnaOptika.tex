...
(glej razdelek~\ref{chap:sunvl}). Pri tem je ključen parameter disperzija grupne hitrosti
oziroma drugi odvod valovnega vektorja po krožni frekvenci.
...
čirikanje izničimo (b) in nastane sunek svetlobe, ki oblike ne spreminja~\textendash~soliton.}
\label{fig:chirp}
\end{figure}
...
\end{equation}
pri čemer je $\omega_0$ osrednja krožna frekvenca svetlobnega sunka in $k_0 = \omega_0 n/c_0$. Vpeljemo še
$\Omega =\omega - \omega_0$
\begin{equation}
...
\end{equation}
pri čemer $'$ označuje odvod po krožni frekvenci, in prepišemo enačbo v 
\begin{equation}
...
ohranja in žarek se še naprej razširja. Na fazno konjugiranem zrcalu se krogelni val spet
...
V meter dolgem odseku vlakna pride tako pri gostoti svetlobnega toka $10^{10}~\si{\watt/\meter^2}$ 
...
\index{Nelinearna optika!v vlaknih}
...
(SRS)\index{Ramanovo sipanje!stimulirano}, ki smo
ga spoznali v razdelku~(\ref{chap:SRS}). Spomnimo se, da se pri SRS intenziteta
...
optično vzbujenem akustičnem valu v snovi (razdelek~\ref{chap:SRS}). Signal
...
lomnega količnika z intenziteto vpadne svetlobe (optični Kerrov pojav, razdelek~\ref{OKP}).
Opišimo tri pojave:
\begin{enumerate}
\item 
