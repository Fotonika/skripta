...
pa vse do bližnjega infrardečega valovanja.\index{Ultravijolično valovanje}
...
polprevodnik ($p$), na katerem je plast dielektrika (SiO$_2$), na njej pa je elektroda (siva). 
...
pretvorimo v napetost, to pa v digitalni zapis. Vsakemu slikovnemu elementu priredimo
