...
\label{TermOdziv}
\end{equation}
Imaginarni del predstavlja fazni zamik, amplituda odziva pa je 
...
InAs, InSb in PbS, \index{InAs}\index{InSb}\index{PbS}
...
Elektrode se pogosto prepletajo, da se zmanjša dolžina preleta $l$ in poveča faktor ojačenja signala $G$. 
\end{remark}
...
Na sliki to predstavlja premico, ki seka karakteristične krivulje (slika~\ref{11_IU}). Zaradi končne upornosti se po grafu ob naraščajoči moči vpadne svetlobe ne premikamo več navpično navzdol, 
...
plasti na strani $p$) in $d_n$ (debelina izpraznjene plasti na strani $n$) podana z 
\beq
...
\caption{Kvantni izkoristek $p$-$i$-$n$ (Si in Ge) in Schottkyjevih (Au-Si in Ag-ZnS)
fotodiod}
\label{11_odziv}
\vglue-3truemm
\end{figure}
...
v dani časovni enoti za en slikovni element -- piksel\index{Piksel}. 
...
ali fotoprevodnikov\index{Fotoprevodnik} (za infrardeče valovanje),\index{Infrardeče valovanje}
