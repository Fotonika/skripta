...
Detektorji svetlobe so nujni za kvantitativno obravnavo
...
\label{temp_sens}
\end{equation}
Občutljivost detektorja, ki je sorazmerna z razliko temperatur, je torej
...
Če želimo toplotne izgube povečati in s tem skrajšati odzivni čas,
detektorje hladimo z zrakom ali celo z vodo. 
Navzdol so toplotne izgube omejene s sevanjem.  
...
\end{equation}
Kapaciteto izrazimo z odzivnim časom $\tau$ (enačba~\ref{TermD_t}) in \index{Detektor!odzivni čas}dobimo:
\begin{equation}
...
upornost se močno spreminja s temperaturo.}, \index{Termistor} polprevodnika ali superprevodnika 
...
tako da postane sistem neobčutljiv na morebitne temperaturne spremembe okolice.
\begin{figure}[ht]
\centering
...
polarizacija odvisna od temperature. Take snovi so na primer LiTaO$_3$,\index{LiTaO$_3$} 
...
(zunanji fotoefekt)\index{Fotoefekt!zunanji}
...
do bližnjega infrardečega valovanja.\index{Ultravijolično valovanje}
...
(slika~\ref{fig:Fotodioda}).\index{Infrardeče valovanje}\index{Ultravijolično 
valovanje}\footnote{~Slika povzeta po {\it Photomultiplier Tubes, Basics and Applications}, tretja izdaja, Hamamatsu
Photonics (2007).}
\begin{figure}[ht]
\centering
...
ki je pod še višjo napetostjo, itd. 
...
širine reže. Na primer za silicij\index{Silicij} je širina reže $1,1$~eV in največja
...
$2~\si{\micro\meter}$ in $7~\si{\micro\meter}$ so najprimernejši detektorji InAs, InSb in PbS, 
\index{InAs}\index{InSb}\index{PbS}
pri še daljših valovnih dolžinah se uporablja germanij, dopiran z zlatom, bakrom, cinkom, borom itd.
...
Najpomembnejši primer detektorjev, ki temeljijo na notranjem fotoefektu,\index{Fotoefekt!notranji}
...
Celotni tok skozi spoj $p$-$n$ oziroma diodo je sestavljen iz prispevkov 
elektronov in vrzeli. Opiše ga
...
v zaporni smeri. Tudi iz enačbe~(\ref{11:fotodioda}) je razvidno, da je tok 
...
\begin{naloga}
\label{naloga:depl}
Pokaži, da je debelina izpraznjene plasti enaka $d = d_p+d_n$, pri čemer sta 
$d_p$ (debelina izpraznjene
...
\index{Fotodioda!heterostrukturna}fotodiode, kjer sta dela $p$ in $n$
...
visokih energijah (v ultravijoličnem območju, slika~\ref{11_odziv}), \index{Fotodioda!Schottkyjeva}\index{Ultravijolično valovanje}
...
\section{Detektorji CCD in CMOS}
...
Schottkyjevih fotodiod\index{Fotodioda!Schottkyjeva} (npr. PtSi, ki seže od ultravijolične svetlobe do
okoli $6~\si{\micro\meter}$) ali plazovnih fotodiod.\index{Fotodioda!plazovna}\index{Ultravijolično valovanje}
\vglue-9truemm
\end{remark}

\subsection*{CCD}
Detektorji CCD\index{Detektor!CCD} so sestavljeni iz posameznih tako imenovanih kondenzatorjev MOS 
...
dala tudi ime.
Danes je kovino večinoma nadomestil polikristalni silicij (polisilicij).
...
digitalno vrednost barvne globine glede na število vpadnih fotonov oziroma elektronov. Pri 
tem, na primer, 8-bitni zapis slike vsakemu elementu priredi vrednost od 0 do 255, 16-bitni pa od 0 do 65535.
...
od CCD. Odlikujeta jih tudi nizka poraba energije in nizka cena. Njihovi slabosti
sta večji šum in manjša občutljivost, saj del zaslona, kjer so ojačevalniki, slike ne more
zajemati. 
...
\label{SNRs}
\end{equation}
Po pričakovanjih je to razmerje večje pri večjem povprečnem signalu in daljši meritvi.
...
Upoštevamo zvezo $\overline{W} = \overline{P}\tau_e$, pri čemer je 
$\tau_e$ odzivni čas vezja in je enak $\tau_e = RC$. Sledi:
\begin{equation}
...
Termični šum je odvisen od temperature in upornosti detektorja oziroma
...
hlajenje. Na ta način lahko termični šum zelo zmanjšamo, 
nikoli pa ga ne moremo povsem
odpraviti.  
...
primer pri siliciju.\index{Silicij} Germanij \index{Germanij} ima 
...
v infrardeči del spektra\index{Infrardeče valovanje} ali celo v vidno svetlobo. 

Sevanje ozadja predstavlja največji problem pri meritvah v
območju valovnih dolžin okoli $10$--$30~\si{\micro\meter}$, v katerem 
znatno sevajo že telesa 
pri sobni temperaturi. 
Detektorjem za infrardeče valovanje zato pogosto zmanjšamo aperturo 
...
načina detekcije, sevanja ozadja itd.
\newpage
