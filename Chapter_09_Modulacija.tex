...
\boxeq{7.1}{
\delta b_{ij}=\sum_{k=1}^3 r_{ijk}E_{k}+ \sum_{k=1}^3 \sum_{l=1}^3 q_{ijkl}E_{k}E_{l} = 
r_{ijk}E_{k}+q_{ijkl}E_{k}E_{l}.
}
...
ali Pockelsov\index{Pockelsov pojav} pojav\footnote{Nemški fizik Friedrich Carl Alwin Pockels, 1865--1913.}. Tenzor tretjega ranga $r_{ijk}$ imenujemo elektro-optični 
