...
pa Kerrov tenzor\index{Kerrov tenzor}. \index{Elektro-optični pojav!kvadratni|see {Kerrov pojav}}Kerrov pojav je praviloma precej šibkejši od Pockelsovega, vendar je prisoten 
...
\end{equation}
Dodatna polarizacija v valovno enačbo doprinese nehomogen člen. Zapišemo\index{Valovna enačba}
\begin{equation}
...
periodo kot potencial.\index{Blochov teorem}
\end{remark}
...
Da dobimo disperzijsko odvisnost, moramo rešiti gornjo kvadratno enačbo. 
