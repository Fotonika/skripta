...
ali holesteriku pri izbranem $\alpha$. Razen v frekvenčni reži (modra pasova) obstajajo pri vsaki frekvenci
štiri rešitve za $k$.}
\label{gap}
\end{figure}
\end{remark}
...
Poglejmo še, kako narašča amplituda deformacije v bližini Frederiksovega prehoda. Iz enačbe~(\ref{7.79})
sledi 
\begin{equation}
