...
\begin{equation}
\mathbf{E}(\mathbf{r},t)  =\Re(\mathbf{E}(\mathbf{r})e^{-i\omega t})\qquad \textrm{in} \qquad
\mathbf{B}(\mathbf{r},t)  =\Re(\mathbf{B}(\mathbf{r})e^{-i\omega t}),
\label{eq:rval}
\end{equation}
...
Vpeljemo še povprečni Poyntingov vektor\index{Poyntingov vektor}, povprečen
po eni periodi,
\begin{equation}
...
snovi, je enaka velikosti gostote energijskega toka $j$\index{Gostota energijskega toka}
\boxeq{eq:jcw}{
