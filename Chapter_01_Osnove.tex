...
čemer se bomo držali enačb~(\ref{eq:rval}). Zavedati se moramo, da
...
(močno zbran laserski snop) jakost polja $E_{0}=27~\si{MV/m}$. 
...
svetloba razkloni. Valovna vektorja sta v tem primeru vzporedna, 
