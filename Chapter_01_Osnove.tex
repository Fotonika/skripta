...
kadar je krog, govorimo o cirkularno polariziranem valu\index{Polarizacija!cirkularna}. 
...
Za zapis cirkularno polariziranega valovanja ni enotnega dogovora. Tukaj pišemo
desno cirkularno polarizirano valovanje kot 
$\mathbf{J}=\left(1,-i\right)/\sqrt{2}$ in
levo cirkularno polarizirano kot $\mathbf{J}=\left(1,i\right)/\sqrt{2}$.
...
spremeni v levo cirkularno polarizirano valovanje in cirkularno polarizirano
...
(sliki a in c). Vidimo, da je pri neki vrednosti vpadnega kota $\vartheta_1$ odbojnost za 
...
Naj svetloba iz točkastega izvora v točki $T$ (slika \ref{fig:UklonFK}) vpada na zaslon
...
V optično enoosnem kristalu (desno) je le ena optična os, \index{Polarizacija}
...
ko je optična os vzporedna ali pravokotna na mejno ploskev. 
...
pokažemo, da imata sliki različni polarizaciji.}\index{Polarizacija}
\label{foto:dvolom}
\end{figure}
