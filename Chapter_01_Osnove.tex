...
\end{equation}
kjer je $I_P$ intenziteta valovanja na zaslonu v točki s koordinatama $(x,z)$ in $k$ valovno število.
\end{naloga}
...
\end{equation}
kjer je $I_P$ intenziteta valovanja na zaslonu, $k$ valovno število, $a$ polmer odprtine, 
...
kjer velja $n_e< n_o$ (b). V obeh primerih je redni 
...
so valovne fronte (ploskve konstantne faze) pravokotne nanj. To velja tudi za redni žarek v anizotropnih snoveh (slika \ref{fig:Elipsa}\,c). 
