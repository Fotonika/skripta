...
\index{Magnetizacija}magnetizacijo, to je gostoto magnetnega momenta. Pri tem sta
...
\begin{naloga}
\label{naloga:evp}
Izračunaj jakost električnega polja v evanescentnem polju. Pokaži, da
...
razvoj do linearnih členov, govorimo o Fraunhoferjevem uklonskem približku 
in uklonski integral je:
\begin{equation}
...
polarizirano valovanje\index{Polarizacija!eliptična}. Lastni komponenti namreč potujeta različno
...
količnik\index{Lomni količnik!izredni}.\footnote{~Za $n_o$ uporabljamo tudi 
