...
Povejmo še nekaj o parametru $q(z)$, ki smo ga uporabili pri izračunu 
...
Da so tudi to rešitve obosne valovne enačbe, se 
...
$L_{1}^{l}(x) = -x+l+1$, 
$L_{2}^{l}(x) = x^2/2-(l+2)x+(l+2)(l+1)/2$ ..., Gouyjeva faza pa je 
...
količino\index{Tirna vrtilna količina}.
...
\end{equation}
kjer je $m$ zaradi periodičnosti rešitev
celo število in $J_{m}$ Besslova funkcija reda $m$. Za
